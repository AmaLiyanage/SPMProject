...
import { getStories, Story } from "./storiesStore";
  ...
  return (
    <View style={styles.container}>
      <View style={styles.topBar}>
        ...
        <Text style={styles.screenTitle}>#{tag}</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  screenTitle: { fontSize: 22, fontWeight: "bold", color: "#8B5CF6", marginLeft: 12 },
  card: {
